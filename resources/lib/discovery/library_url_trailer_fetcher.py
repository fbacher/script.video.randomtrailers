...
class LibraryURLTrailerFetcher(AbstractTrailerFetcher):
    """
    ...
    def __init__(self, *args: Any, movie_data: AbstractMovieData = None,
        ...
        thread_name: Final[str] = f'{MovieField.LIBRARY_URL_TRAILER}_fetcher'
        ...
        self._child_trailer_fetchers: List['LibraryURLTrailerFetcher'] = []
