...
class TMDbTrailerFetcher(AbstractTrailerFetcher):
    """
    ...
    def __init__(self, *args: Any, movie_data: AbstractMovieData = None,
        ...
        thread_name: Final[str] = f'{MovieField.TMDB_SOURCE}_fetcher'
        ...
        self._child_trailer_fetchers: List['TMDbTrailerFetcher'] = []
