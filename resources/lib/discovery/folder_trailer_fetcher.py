...
class FolderTrailerFetcher(AbstractTrailerFetcher):
    """
    ...
    def __init__(self, *args: Any, movie_data: AbstractMovieData = None,
        ...
        thread_name: Final[str] = f'{MovieField.FOLDER_SOURCE}_fetcher'
        clz._logger.debug(f'movie_data: {movie_data} thread_name: {thread_name} ')
        ...
        self._child_trailer_fetchers: List['FolderTrailerFetcher'] = []
