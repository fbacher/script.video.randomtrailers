...
class AdvancedPlayer(xbmc.Player):
    ...
    def onAVStarted(self):
        ...
        Trace.log(localLogger.getMsgPrefix() + u' ' +
                  self.getPlayingTitle(), Trace.TRACE)
    ...
    def waitForIsPlayingVideo(self, timeout=None):
        ...
        kodiMonitor = Monitor.getSingletonInstance()
    ...
    def waitForIsNotPlayingVideo(self, timeout=None):
        '''
        This is a mess.
