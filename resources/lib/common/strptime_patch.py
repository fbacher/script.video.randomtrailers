...
class StripTimePatch(datetime.datetime):
    ...
    if not hasattr(datetime.datetime, 'monkey_patched'):
    ...
    def my_isinstance(o, t):
        if StripTimePatch.real_isinstance is None:
            return isinstance(o, t)

        if t is StripTimePatch:
            t = StripTimePatch.real_datetime_class
        return StripTimePatch.real_isinstance(o, t)
